...
import { AdminLoading, AdminPageHeader, admin } from '@/components/admin/admin-ui';
...
export default function AdminSettingsPage() {
    ...
    return (
        <div className="space-y-6">
            <AdminPageHeader title="Settings" subtitle="Rates, limits, and fees for deposits and withdrawals" />
