      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-6 sm:py-12">
        ...
        <div className="prose prose-slate max-w-none space-y-6 text-slate-600">
          ...
          <section>
            ...
            <p>
              Stepay facilitates the purchase and sale of Stellar Lumens (XLM) and USDC using mobile money. We connect you with the Stellar network and supported mobile money providers in your region.
            </p>
          </section>
          <section>
            <h2 className="text-lg sm:text-xl font-semibold text-slate-900 font-heading mt-6 sm:mt-8 mb-3 sm:mb-4">3. Eligibility</h2>
            <p>You must be at least 18 years old and have a valid mobile money number in a supported region to use the Service.</p>
          </section>
          <section>
        ...
        <div className="mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-slate-200">
          <Link href="/" className="text-[var(--brand-accent)] hover:text-[var(--brand-accent-hover)] font-medium py-3 min-h-[44px] inline-flex items-center transition-colors">
            ← Back to Home
          </Link>
        </div>
      </main>
